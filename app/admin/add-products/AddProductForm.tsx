...
const AddProductForm = () => {
  ...
  return (
    <>
      <Heading title="Add a Bottle" center />
      <Input
        id="name"
        label="Bottle Name"
        disabled={isLoading}
      ...
      <CustomCheckBox
        id="inStock"
        register={register}
        lable="This Product is in stock."
      />
      {/* select category section */}
      <div className="w-full font-medium">
        <div className="mb-2 font-semibold">Select a Category</div>
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 max-h[85vh] overflow-y-auto">
          {categories.map((item) => {
            if (item.label === "All") {
              return null;
            }
      ...
      <div className="w-full flex flex-col flex-wrap gap-4">
        <div>
          <div className="font-bold">
            Select the available product colors and their images.
          </div>
      ...
      {/* submit button */}
      <Button
        lable={isLoading ? "Loading..." : "Add Bottle"}
